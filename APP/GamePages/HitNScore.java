...
class WhacAMole implements KeyListener
{
	 int boardWidth = 600;
    ...
    WhacAMole() {
        ...
        Image plantImg = new ImageIcon(getClass().getResource("APP/images/piranha.png")).getImage();
        plantIcon = new ImageIcon(plantImg.getScaledInstance(150, 150, java.awt.Image.SCALE_SMOOTH));

        Image moleImg = new ImageIcon(getClass().getResource("APP/images/monty.png")).getImage();
